...
export const schema = yup.object().shape({ 
        firstname: yup.string().max(10).required("firstname is mandatory").matches(nameRegExp), //Should be of string type and allows maximum 10 character and it should match with the nameRegExp
