            ...
            <div className="container">
              <div className="main">
                <div className="page-title-wrapper">
                  ...
                  <p>
                    Creating an account has many benefits: check out faster and
                    more.
                  </p>
                </div>
                <div className="columns">
                  <div className="column main">
                    <div className="register-container">
                      <div className="block block-customer-register">
                        <form
                          className="htmlFor create account htmlFor-create-account"
                          method=""
                          id="htmlFor-validate"
                          encType="multipart/htmlFor-data"
                          autoComplete="off"
...
<<<<<<< HEAD
                          ...
                          >
                            ...
                            <div className="field required">
                              <label htmlFor="mobile_no" className="label">
                              ...
                              <div className="control">
                                <input
                                  ...
                                  id="mobile_no"
                                  title="Mobile Number"
                                  className="input-text validate-numbe validate-number-range"
                                  data-validate="{required:true, 'validate-number':true, 'minlength':10, 'maxlength':10} "
                                  autoComplete="off"
                                  aria-required="true"
                                  {...register("mobile_no")}
                                  maxLength="10"
...
>>>>>>> bf0b78889729225d1ac8275ccf217561dd13fdc9
                            ...
                            <div className="actions-toolbar">
                              <div className="primary">
                                <button
                                  type="submit"
                                  className="action submit primary btn-4"
